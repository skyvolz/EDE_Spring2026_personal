...
> strong negative correlation between irradiance and depth. depth coefficient is negative so as depth increases, light decreases. depth explains about 30% of the variability. p-value is smaller than confidence level so it is meaningful.
...
par(mfrow = c(2,2), mar=c(4,4,4,4)) #didivding screen into a grid
