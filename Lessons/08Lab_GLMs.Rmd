...
EPAair %>% 
  ...
  labs(x="Ozone AQI Value", y="Density", title="Density Plot: Ozone by Year") +
  scale_fill_manual("Year",values=c('red','blue'))
...
EPAair %>% 
  ...
  labs(x="") +
  stat_summary(
    geom = "text",   #make it a text instead of a point
    fun = max,       #what stat
    label = c("a","b"),
    color='red',
    vjust= -1
...
#darker = more significance 
#ozone doesnt have redundancy
